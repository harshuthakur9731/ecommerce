...
urlpatterns = [
    ...
    path('addToCartAct/delToCartAct/<slug:itemid>',views.delToCartAct,name="delToCartAct"),
    path('itemdetail/addToCartAct/<slug:PCode>',views.addToCartAct,name="addToCartAct"),
